...
void setup_scr_setup(lv_ui *ui){
	...
	lv_obj_set_style_local_text_font(ui->setup_btnsetback_label, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, &lv_font_montserrat_12);
	...
	lv_style_set_text_font(&style_setup_label2_main, LV_STATE_DEFAULT, &shin_comic16);
