...
void setup_select_function(lv_ui *ui){
	...
	//lv_obj_set_width(ui->wifi_home,400);
	//lv_obj_set_height(ui->wifi_home,300);
	lv_obj_set_style_local_bg_color( ui->wifi_home, LV_OBJ_PART_MAIN, LV_STATE_DEFAULT, LV_COLOR_BLACK );
	...
	lv_obj_set_style_local_text_color(ui->wifi_home_label0_1, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, LV_COLOR_WHITE );
	...
	ui->setup_select_function6_btn = lv_list_add_btn(ui->wifi_home_list3, LV_SYMBOL_EDIT, "時計表示 ");
	...
	ui->setup_select_function7_btn = lv_list_add_btn(ui->wifi_home_list3, LV_SYMBOL_EDIT, "テンキー画面 ");
	...
	ui->setup_select_function8_btn = lv_list_add_btn(ui->wifi_home_list3, LV_SYMBOL_EDIT, "エリア設定");
