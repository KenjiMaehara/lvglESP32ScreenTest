...
void setup_scr_saved(lv_ui *ui){
	...
	lv_obj_set_style_local_text_font(ui->saved_btnsavecontinue_label, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, &shin_comic18);
	...
	lv_style_set_text_font(&style_saved_label2_main, LV_STATE_DEFAULT, &shin_comic16);
